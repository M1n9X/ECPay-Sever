#!/bin/bash
# Verification script to compare Python and TypeScript alignment for invoice_cancel

echo "=========================================="
echo "INVOICE_CANCEL ALIGNMENT VERIFICATION"
echo "=========================================="
echo ""

# Run Python test and extract key values
echo "Running Python test..."
PY_OUTPUT=$(python3 test_alignment_invoice_cancel_py.py 2>&1)
...
TS_OUTPUT=$(npx tsx test_alignment_invoice_cancel_ts.ts 2>&1)
