#!/bin/bash
# TCB POS System - One-Click Stop Script
...
echo "=========================================="
echo "  TCB POS System - Stopping Services"
echo "=========================================="
...
if [ -f "$LOG_DIR/server.pid" ]; then
    ...
    if kill -0 $SERVER_PID 2>/dev/null; then
        echo "Stopping Server_TCB (PID: $SERVER_PID)..."
...
if [ -f "$LOG_DIR/mock-pos.pid" ]; then
    ...
    if kill -0 $MOCK_PID 2>/dev/null; then
        echo "Stopping Mock POS (TCB) (PID: $MOCK_PID)..."
